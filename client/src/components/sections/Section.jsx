    ...
    >
      ...
      <div className="group flex items-center justify-between px-2">
          ...
          <div className="flex items-center gap-2 overflow-hidden">
            ...
            {editingSectionId === section._id ? (
              <Input
                ...
                className="h-8 border-border bg-background text-sm shadow-none"
              />
            ) : (
              <motion.span
                layout
        ...
        <Button
          ...
          className="h-8 w-8 rounded-lg opacity-0 transition-all duration-200 hover:bg-accent hover:text-destructive group-hover:opacity-100"
        >
      ...
      <AccordionContent className="space-y-3 px-2 pb-3">
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2 px-2 pt-1 text-[11px] font-medium uppercase tracking-wide text-muted-foreground">
        ...
        <div className="flex gap-2 px-1 pt-1">
          <Button
            ...
            className="h-8 rounded-xl border border-border bg-muted text-xs text-foreground hover:bg-accent hover:text-accent-foreground"
          >
